  ...
  <tbody>
    <tr style="page-break-inside: avoid;">
      ...
      <td style="border: 1px solid #000; padding: 8px;">
        ...
        <p><strong>TF:</strong> Para esta entrega, desarrollé un bot de WhatsApp usando Node.js y evalué su impacto: reconocí mi responsabilidad ética al garantizar que la solución sea accesible y equitativa; consideré el impacto global al usar una plataforma masiva como WhatsApp; valoré el beneficio económico al automatizar procesos y reducir costos; y atendí el impacto ambiental al disminuir el uso de papel mediante digitalización de la atención. </p>
        ...
        <p><strong>TF:</strong> Para la entrega final, participé en el desarrollo del foro para la app, el cual permite a los usuarios tener un espacio de comunicación abierta dentro de la plataforma. Durante su desarrollo, consideré mi responsabilidad ética y profesional al asegurar que la solución sea accesible y equitativa, así como su impacto en el contexto global, económico y social.</p>
        ...
        <p><strong>TF:</strong>En este entregable, contribuí en la documentación de las To-Be Validation Interviews, aplicando los conocimientos del curso para garantizar un desarrollo alineado con principios éticos y profesionales.</p>
      </td>
      <td style="border: 1px solid #000; padding: 8px;">
        ...
        <p><strong>TF:</strong> Para esta entrega, como equipo desarrollamos diversas funcionalidades orientadas a validar hipótesis y mejorar la experiencia de usuario, incluyendo la implementación del foro, el modo oscuro y un bot de WhatsApp, todas integradas como parte de experiment cards. En cada uno de estos desarrollos aplicamos buenas prácticas de accesibilidad, diseño y desarrollo ético, evaluando su impacto en la interacción, la comodidad visual, la automatización de procesos y la reducción de costos. Asumimos de forma colectiva nuestra responsabilidad profesional, considerando la equidad, accesibilidad e impacto global, económico, social y ambiental de nuestras soluciones dentro del contexto de la aplicación.</p>
      </td>
    </tr>
    <tr style="page-break-inside: avoid;">
      ...
      <td style="border: 1px solid #000; padding: 8px;">
        ...
        <p><strong>TF:</strong> Se desarrolló un bot de WhatsApp con Node.js, evaluando su impacto global, económico, ambiental y social. Automatiza atención, reduce costos y consumo de papel, mejora accesibilidad y equidad al ofrecer servicios inmediatos y sin barreras, demostrando un compromiso ético y responsable en la ingeniería de software. </p>
        <p><strong>Salinas Torres, Salvador Antonio</strong></p>
        ...
        <p><strong>TF:</strong> Implementé el modo oscuro y el foro como parte de experiment cards, evaluando su impacto en la interacción de usuarios. Consideré su relevancia ética y profesional, asegurando que la solución sea accesible y equitativa. Para ello, se realizó el análisis de las opiniones de los usuarios y conocer si realmente estas funcionalidades aportan a la experiencia de usuario.</p>
        <p><strong>Qqueso Rodriguez, Britney Delhy</strong></p>
        ...
        <p><strong>TF:</strong>En esta entrega, ejecutamos To-Be Validation Interviews con los segmentos objetivo, diseñando un guión de entrevistas para verificar las hipótesis de los experimentos. El enfoque consistió en recopilar insights directos de los usuarios acerca de las nuevas funcionalidades implementadas en la plataforma.</p>
      </td>
      <td style="border: 1px solid #000; padding: 8px;">
        ...
        <p><strong>TF:</strong> Como equipo, analizamos los resultados de encuestas y entrevistas para evaluar el impacto de los experimentos en la experiencia de usuario e identificar áreas de mejora. Implementamos funcionalidades como el foro y el modo oscuro dentro de experiment cards, evaluando su aporte a la usabilidad, accesibilidad y personalización de la aplicación, así como su valor en contextos reales de comunicación y colaboración. Además, desarrollamos un bot de WhatsApp con Node.js, destacando su impacto positivo en la automatización de la atención, la reducción de costos y el cuidado ambiental. En todos los casos, actuamos con responsabilidad ética y profesional, priorizando soluciones accesibles, equitativas y centradas en el usuario.</p>
      </td>
    </tr>
  </tbody>
</table>
...
Exposición TF1: [upc-pre-202501-1asi0732-4429-Innovatech-expo-tf1.mp4](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20221b127_upc_edu_pe/EZlSKkm9cJBMrKIn_lwR2zMBevsEQSxW5nsDGRoxQXoWCw?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=3iXo7v)