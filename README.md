  ...
  <tbody>
    <tr style="page-break-inside: avoid;">
      ...
      <td style="border: 1px solid #000; padding: 8px;">
        ...
        <p><strong>TP:</strong>En esta entrega, colaboré de manera activa en el diseño y ejecución de pruebas BDD, con el objetivo de verificar el correcto funcionamiento del Backend.
    ...
    <tr style="page-break-inside: avoid;">
      ...
      <td style="border: 1px solid #000; padding: 8px;">
        ...
        <p><strong>TP:</strong>En el proyecto, me encargué de desarrollar y ejecutar pruebas BDD (Behavior Driven Development) para validar que el sistema cumpliera con el comportamiento esperado desde la perspectiva del usuario. Utilicé herramientas como Cucumber para definir escenarios en lenguaje natural
        <p><strong>Pecan Pariona, Sergio Joel</strong></p>
